...
- To investigate sampling correctness or convergence, start with `27-renderer-sampling-audit-and-repair-plan.md`; first T1 GGX, T2/local R5 MIS, and T3/T7 terminal-depth repairs have focused GPU coverage. Broader acceptance remains pending; S1/S2/S3 are next. Phase 1 is in progress, not complete.
