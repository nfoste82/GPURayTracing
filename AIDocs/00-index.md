...
- To investigate sampling correctness or convergence, start with `27-renderer-sampling-audit-and-repair-plan.md`; first T1 GGX and T2/local R5 MIS repairs have focused GPU coverage. Broader acceptance remains pending; T3/T7 are next. Phase 1 is in progress, not complete.
