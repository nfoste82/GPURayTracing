...
- `GameManager.enableAdaptiveSampling`: retained as an experimental toggle and capture-comparison seam. The legacy adaptive implementation was removed; `CSMain` currently remains the uniform progressive baseline regardless of this toggle.
