...
- `Benchmark_Water`: stresses the finite water AABB's ray-marched top and flat side/bottom boundaries, Fresnel reflection/refraction, distance-based absorption, and distinct shore-only, water-only, and water-over-bed regions. Accumulation is disabled for animated water.
