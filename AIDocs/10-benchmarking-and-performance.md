...
- `DemofoxRoughRefraction`: seven otherwise matching low-IOR glass spheres progressing from smooth to frosted, in front of a black-and-white stripe backdrop. It is modeled after [Demofox's rough-refraction fixture](https://www.shadertoy.com/view/ttfyzN) and makes refraction blur and the broadening of floor patterns directly comparable. The HDR orchard environment and highlight reconstruction keep the increasingly broad rough-transmission lobes visible; the panel retains the fixture's migrated physical mesh-radiance exposure.
