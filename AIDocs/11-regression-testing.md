...
- Image fixtures mirror the production `224`-byte triangle layout and bind neutral albedo, metallic/roughness, and normal texture arrays so missing-map defaults remain deterministic.
