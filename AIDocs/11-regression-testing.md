...
- Caustics coverage dispatches the production clear/trace kernels with a fixed seed, compares canonically sorted photon records, verifies default-disabled resource isolation, locks a focused sphere-caustic image signature, and checks energy stability across photon counts and gather radii.
