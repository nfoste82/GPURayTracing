...
public sealed class SceneSettings
{
    ...
    public float AdaptiveGroupRmsScoreBlend = 0.5f;
    public float AdaptiveExplorationShare = 0.5f;
    ...
    public float FireflyClamp = 35.0f; // 0 (none), 1 (fully clamped), the higher the number past 1 the brighter the values are allowed to be
