...
public class RayTracingBenchmarkOverlay : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        _builder.Append("Temporal RIS: ").Append(gameManager.Lighting.TemporalRisEnabled ? "enabled" : "fallback")
            .Append("  History M cap: ").AppendLine(gameManager.Lighting.TemporalRisHistoryMCap.ToString());
        _builder.Append("Spatial RIS: ").Append(gameManager.Lighting.SpatialRisEnabled ? "experimental" : "off")
            .Append("  Neighbors: ").AppendLine(gameManager.Lighting.SpatialRisNeighborCount.ToString());
